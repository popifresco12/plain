#!/usr/bin/env python3
"""Prueba de humo del API de empresas contra un backend LOCAL en marcha.

Es un script manual, no un test de pytest: antes vivía en test_business.py y
al recolectarlo pytest hacía peticiones a localhost:8000 (URLError) y rompía
toda la suite. Para las pruebas automáticas usa test_radius.py y test_main.py.

Uso: python scripts/smoke_business.py   (con el backend levantado en :8000)
"""
